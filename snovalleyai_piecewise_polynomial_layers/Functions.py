...
def basis1DG1(x) :
    ...
    res1 = pos*tf.convert_to_tensor([xr*0.0, xr*0.0, -0.5*(xr-1.0),0.5*(xr+1.0)])
    res2 = neg*tf.convert_to_tensor([-0.5*(xl-1.0),0.5*(xl+1.0),xl*0.0,xl*0.0])
...
def basis2CG1(x) :
    ...
    res1 = pos*tf.convert_to_tensor([x*0.0, x*0.0, 0.5*xr*(xr-1.0),-1.0*(xr+1)*(xr-1), 0.5*xr*(xr+1.0)])
    res2 = neg*tf.convert_to_tensor([0.5*xl*(xl-1.0),-1.0*(xl+1)*(xl-1),0.5*xl*(xl+1.0),x*0.0,x*0.0])
...
def basis2DG1(x) :
    ...
    res1 = pos*tf.convert_to_tensor([x*0.0, x*0.0, x*0.0, 0.5*xr*(xr-1.0),-1.0*(xr+1)*(xr-1), 0.5*xr*(xr+1.0)])
    res2 = neg*tf.convert_to_tensor([0.5*xl*(xl-1.0),-1.0*(xl+1)*(xl-1),0.5*xl*(xl+1.0),x*0.0,x*0.0,x*0.0])
